    ...
    <div id="main-content" class="flex-1 transition-all duration-300 ease-in-out p-6 w-full ml-0">
        ...
        <div class="bg-white rounded-xl shadow-xl p-6 w-full max-w-6xl mx-auto">
            ...
            <div class="flex items-center mb-4">
                ...
                <button onclick="buscarVenta()" class="bg-[#FF6200] text-white py-2 px-4 rounded ml-4 btn">Buscar</button>
            </div>
                    ...
                    <thead>
                        <tr class="text-center bg-[#D9D9D9]">
                            ...
                            <th class="border border-black p-4">
                                <button onclick="abrirModal()" class="bg-[#FF6200] text-white px-4 py-2 rounded btn">Crear Venta</button>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="text-center bg-[#D9D9D9]">
                            ...
                            <td class="border border-black p-4 space-x-2">
                                <button onclick="abrirModalEditar()" class="bg-blue-500 text-white px-6 py-3 rounded btn">Editar</button>
                                <button onclick="deshabilitarVenta()" class="bg-gray-700 text-white px-6 py-3 rounded btn">Deshabilitar</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
